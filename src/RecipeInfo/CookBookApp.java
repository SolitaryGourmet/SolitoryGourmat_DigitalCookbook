...
public class CookBookApp {
	...
	private static Recipe createHongShaoRou() {
		...
		//additional task: add category 
		recipe.addCategory(new Category("Hunan", "sweat, salty", "lunch, dinner", "pork", false));
	...
	private static Recipe createSuanLaFen() {
		...
		//additional task: add category 
		recipe.addCategory(new Category("Sichuan", "spicy, salty", "lunch, dinner", " " , true));
	...
	public static void main(String[] args) {
		...
		//recalculate serving number
		Recipe newRecipe = cb.recalculateServeNum(recipe, 8);
